...
if(${LIBOPENCM3_MAKE_BUILD})
    ...
    foreach(SOURCE_FILE ${LIBOPENCM3_SOURCES})
        ...
        cmake_path(RELATIVE_PATH SOURCE_FILE_PATH_NORMALIZED BASE_DIRECTORY ${PROJECT_SOURCE_DIR} OUTPUT_VARIABLE SOURCE_FILE_PATH_RELATIVE)
        file(APPEND ${LIBOPENCM3_PARSED_SOURCES} "${SOURCE_FILE_PATH_RELATIVE}\n")
    endforeach()
